...
public:
  ...
  void check_inode_max_size(CInode *in, bool force_wrlock=false, bool update_size=false, uint64_t newsize=0,
			    utime_t mtime=utime_t());
  void check_client_want_max(CInode *in, client_t client, uint64_t want_max);
