...
#define CEPH_FEATURE_RECONNECT2 2  /* mds responds to reconnect with OPEN */

#define CEPH_FEATURE_SUPPORTED_MON    (CEPH_FEATURE_UID)
#define CEPH_FEATURE_REQUIRED_MON     (CEPH_FEATURE_UID)
#define CEPH_FEATURE_SUPPORTED_MDS    (CEPH_FEATURE_UID|CEPH_FEATURE_RECONNECT2)
...
#define CEPH_FEATURE_SUPPORTED_CLIENT (CEPH_FEATURE_RECONNECT2)
